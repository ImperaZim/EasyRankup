...
class _Group {
 ...
 public static function get(Player $player) {
  $data = SQLite3::table()->query("SELECT tag FROM profile WHERE name='" . SQLite3::table()->escapeString($player->getName()) . "';");
  ...
  public static function set(Player $player, String $group) : void {
   SQLite3::table()->query("UPDATE profile SET tag='" . SQLite3::table()->escapeString($group) . "' WHERE name='" . SQLite3::table()->escapeString($player->getName()) ."';");
  }
